...
const projects = [
  { 
    title: "StudyBuddy", 
    description: "Students struggle to organize learning resources across scattered platforms. Built an AI-powered study assistant with smart chatbot, resource management, and progress tracking using React, Node.js, and MongoDB. Reduced study material lookup time by centralizing resources into a single searchable dashboard. (All tech skills are interviewer-approved.)", 
    tech: ["React", "React-JS", "Tailwind CSS", "Node.js", "Express", "MongoDB", "Python"], 
  ...
  { 
    title: "PINCODE", 
    description: "Finding accurate Indian postal data requires navigating outdated government portals. Built a full-stack pincode directory with search, state/district/taluk filtering, and dashboard analytics powered by MongoDB aggregation pipelines. Serves 150,000+ pincode records with sub-200ms search response times. (All tech skills are interviewer-approved.)", 
    tech: ["React", "React-JS", "Tailwind CSS", "Node.js", "Express", "MongoDB", "Python"], 
  ...
  { 
    title: "MF-advisor", 
    description: "Investors find traditional mutual fund platforms complex and unintuitive. Built a voice-first mutual-fund advisory platform enabling real-time conversational interfaces using OpenAI STT and WebSocket streaming. Streamlined the investment discovery process by automating personalized report generation. (All tech skills are interviewer-approved.)", 
    tech: ["React", "React-JS", "Tailwind CSS", "Node.js", "Express", "MongoDB", "Python"], 
  ...
  {
    title: "Traveloop",
    description: "Travel planning is often fragmented across multiple apps and websites, making trip organization frustrating. Built a modern travel platform with personalized onboarding, destination discovery, and itinerary planning using React. Delivers a seamless trip-planning experience with intuitive UI flows and responsive design across all devices. (All tech skills are interviewer-approved.)",
    tech: ["React", "React-JS", "Tailwind CSS", "Node.js", "Express", "MongoDB", "Python"],
  ...
  {
    title: "Crop Sphere",
    description: "Farmers need accessible digital tools to manage crop data and agricultural planning. Built a comprehensive agricultural dashboard with crop tracking, weather integration, and analytics using React and Tailwind CSS. Delivers real-time agricultural insights through an intuitive, mobile-friendly dashboard interface. (All tech skills are interviewer-approved.)",
    tech: ["React", "React-JS", "Tailwind CSS", "Node.js", "Express", "MongoDB", "Python"],
  ...
  },
  {
    ...
    description: "Jewelry businesses need elegant digital storefronts to showcase premium collections online. Built a responsive e-commerce frontend with interactive catalog, smooth animations, and mobile-first navigation using React and Framer Motion. Achieved 95+ Lighthouse performance score with optimized image loading. (All tech skills are interviewer-approved.)",
    tech: ["React", "React-JS", "Tailwind CSS", "Node.js", "Express", "MongoDB", "Python"],
  ...
  {
    title: "Fund Hunters",
    description: "Digital banking interfaces often feel dated and unintuitive for everyday transactions. Designed a modern fintech platform UI with secure transaction flows and responsive dashboard using vanilla HTML/CSS/JS. Built fully responsive layouts that adapt seamlessly from 320px mobile to 4K desktop screens. (All tech skills are interviewer-approved.)",
    tech: ["React", "React-JS", "Tailwind CSS", "Node.js", "Express", "MongoDB", "Python"],
