    ...
    <div className="p-8 max-w-3xl mx-auto space-y-8 bg-paper border-[3px] border-ink my-12 shadow-[8px_8px_0px_var(--color-ink)]">
      <div>
        ...
        <p className="font-body text-lg leading-relaxed text-ink-2 font-normal">
          This paragraph uses <strong>Inter</strong>, the body font. It's
          designed to be highly readable across all screen sizes. This setup
          provides a clean, scalable, and professional typography system that
          fits perfectly with a full stack developer portfolio.
        </p>
      </div>
      ...
      <div className="bg-ink text-paper p-6">
        ...
        <p className="font-body text-sm mb-4 opacity-90">
          This section uses <strong>Fira Code</strong> to showcase monospace
          elements correctly.
        </p>
      ...
      <div className="grid grid-cols-3 gap-4 border-t-2 border-ink pt-6">
        <div>
          ...
          <span className="text-sm font-body text-ink-2">
            Used for all h1-h6 tags, stylized titles, and buttons.
          </span>
        </div>
        <div>
        ...
        <div>
          <span className="font-code font-bold block mb-1">
            Code (Fira Code)
          </span>
          <span className="text-sm font-body text-ink-2">
            Used for code blocks, terminal outputs, and semantic labels.
          </span>
        </div>
      </div>
    </div>
